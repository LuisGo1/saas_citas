...
import { Search, Filter, Phone, History, MessageSquare, User } from "lucide-react";
                                ...
                                <tr>
                                    <td colSpan={4} className="px-10 py-32 text-center">
                                        <div className="max-w-xs mx-auto space-y-4 opacity-40">
                                            ...
                                            <p className="font-black italic text-xl uppercase tracking-widest text-muted-foreground">No se encontraron clientes</p>
                                            <p className="text-sm font-medium text-muted-foreground">Intenta con otro nombre o número.</p>
                                        </div>
                                    </td>
                                </tr>
                            )}
